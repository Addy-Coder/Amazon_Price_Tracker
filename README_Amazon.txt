This program uses a Amazon URL and scrapes the website for the title and price. You have to input a expected price, your email id(only works fir Gmail)and the product URL
